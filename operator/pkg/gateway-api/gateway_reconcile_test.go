...
func Test_sectionNameMatched(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			assert.Equalf(t, tt.want, listenerNode.ParentRefsTarget(tt.args.refs, "default"), "ParentRefsTarget(%v, %v, %v)", tt.args.listener, tt.args.routeNamespace, tt.args.refs)
		})
	}
}
...
func TestGatewayReconciler_statuses(t *testing.T) {
	...
	t.Run("setHTTPRouteStatuses sets related parent statuses", func(t *testing.T) {
		...
		require.NoError(t, r.setHTTPRouteStatuses(r.logger, ctx, hrList, &gatewayv1.ReferenceGrantList{}, nil))
	...
	t.Run("setGRPCRouteStatuses sets related parent statuses", func(t *testing.T) {
		...
		require.NoError(t, c.List(ctx, hrList))
		require.NoError(t, r.setGRPCRouteStatuses(r.logger, ctx, hrList, &gatewayv1.ReferenceGrantList{}, nil))
